// OUR TRAVEL PLANNER - password protected Vercel sync proxy
...
const TABLE_MAP={
  travel_trips:"couple_travel_trips",
  travel_events:"couple_travel_events",
  travel_budgets:"couple_travel_budgets",
  travel_places:"couple_travel_places"
};
const READ_QUERY={
...
async function sbFetch(table,method="GET",body=null,id=null){
  ...
  const url=`${SUPABASE_URL}/rest/v1/${dbTable}${query?`?${query}`:""}`;
